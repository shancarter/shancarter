...
How, after several attempts at designing the perfect electoral vote calculator, I came to the realization that the best electoral vote calculator shouldn’t include electoral votes or calculations.
...
![Image](/assets/images/512-paths/2008-map.mov)
...
My first frustration was with the core visualization: The U.S. Choropleth map.
...
![Image](/assets/images/512-paths/2008-bubbles.mov)
...
This one we dubbed the “wedding cake.”

![Image](/assets/images/512-paths/p215.png)
This one was called “rainbow brite” for some reason :)
...
and removing those paths simplified the presentation.

![Image](/assets/images/512-paths/p206.png)
At this point we were just trying to simplify and clarify.

![Image](/assets/images/512-paths/p200.png)

![Image](/assets/images/512-paths/p194.png)
Here we collapsed some of the white space to give more room for labels.


![Image](/assets/images/512-paths/p158.png)
Here we added a stepper to guide you through some interesting scenarios. But we dropped that feature quickly.
...
![Image](/assets/images/512-paths/using-graphic.mov)
...
![Image](/assets/images/512-paths/commits.png)

While preparing this talk I was also struck by early on I had arrived at the core form of the final graphic. Of the 257 revisions, on the 15th the core ideas were visible.

The remaining 200 revisions were just sculpting and polish.
